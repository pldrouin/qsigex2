...
{
  public:
    QSigExFitMCMC(): QSigExFit(), fCompiledFunc(NULL), fInterpretedFunc(NULL), fNBurnInIterations("Number of Burn-In Iterations",100000), fNParsingIterations("Number of Parsing Iterations",100000), fParVals(NULL), fParJumps(NULL), fParOANames(new QList<QNamedVar<TString> >), fParOAIndices(new QList<Int_t>), fParOArrays(new QList<QProcArray*>){}
    QSigExFitMCMC(const QSigExFitMCMC &rhs): QSigExFit(rhs), fCompiledFunc(rhs.fCompiledFunc), fInterpretedFunc(rhs.fInterpretedFunc), fNBurnInIterations(rhs.fNBurnInIterations), fNParsingIterations(rhs.fNParsingIterations), fParVals(NULL), fParOANames(new QList<QNamedVar<TString> >(*rhs.fParOANames)), fParOAIndices(new QList<Int_t>(*rhs.fParOAIndices)), fParOArrays(new QList<QProcArray*>){};
