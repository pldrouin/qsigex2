...
template <typename U> class QHNF: public QHN<U>
{
  public:
    ...
    TObject* Clone(const char* newname = "") const{QHNF<U>* ret=new QHNF<U>(*this); if(strcmp(newname,"")) dynamic_cast<TNamed*>(ret)->SetName(newname); return dynamic_cast<TObject*>(ret);}
