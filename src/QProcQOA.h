...
class QProcQOA: public QProcArray
{
  public:
    ...
    virtual ~QProcQOA(){if(fArray) delete fArray; if(fOwnsBuffer) delete[] fBuffer;}
    ...
    void SetBuffer(void* buffer){if(fOwnsBuffer) delete[] fBuffer; fOwnsBuffer=kFALSE; fBuffer=(Char_t*)buffer; fArray->SetBuffer(fBuffer);};
    void UnloadArray();
