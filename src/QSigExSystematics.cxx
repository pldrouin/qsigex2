...
ClassImp(QSigExSystematics)

void QSigExSystematics::FormatDir()
{
  ...
  PRINTF2(this,"\tvoid QSigExSystematics::FormatDir()\n")
  try{
    ...
    cout << "Exception handled by QSigExSystematics::FormatDir\n";
    throw e;
  }
}

void QSigExSystematics::CleanDir()
{
  //This public member function reinitializes the part of the fMyDir TDirectory
  //structure that belongs to QSigExSystematics. It removes the TDirectory
  //"Event Info"

  PRINTF2(this,"\tvoid QSigExSystematics::CleanDir()\n")
  try{
    DelObjsKeys("Event Info",fMyDir);
    fEInfoDir=NULL;
  }catch(int e){
    cout << "Exception handled by QSigExSystematics::CleanDir\n";
    throw e;
  }
}

void QSigExSystematics::ClearCardBuf()
{
...
void QSigExSystematics::LoadCardFile(const Char_t* cardfilename)
{
  ...
  PRINTF4(this,"\tvoid QSigExSystematics::LoadCardFile(const Char_t* cardfilename<",cardfilename,">)\n")
  try{
    if(cardfilename){
    ...
    cout << "Exception handled by QSigExSystematics::LoadCardFile\n";
    throw e;
  }
}

void QSigExSystematics::SetDataFilename(const Char_t* fname)
{
  //This function sets the filename of the raw data file to fname

  PRINTF4(this,"\tvoid QSigExSystematics::SetDataFilename(const Char_t* fname<",fname,">)\n")

  fDataFName=fname;
}

void QSigExSystematics::SetDataObjectName(const Char_t* oname)
{
  //This function sets the object name, relative to the file root, of the TTree
  //object containing the raw data. See QSigExSystematics::LoadCardFile() for an
  //example of object name.


  PRINTF4(this,"\tvoid QSigExSystematics::SetDataObjectName(const Char_t* oname<",oname,">)\n")

  fDataOName=oname;
}

Int_t QSigExSystematics::Get()
{
  ...
  PRINTF2(this,"\tInt_t QSigExSystematics::Get()\n")
  ...
  try{
    ...
    cout << "Exception handled by QSigExSystematics::Get\n";
    throw e;
  }
}

void QSigExSystematics::CheckIfDataFilename() const
{
...
void QSigExSystematics::CheckIfDataObjectName() const
{
...
void QSigExSystematics::CheckCuts() const
{
