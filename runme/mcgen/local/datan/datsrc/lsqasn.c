...
void LIBFUNC lsqasn_(double (CBFUNC P_T *userfn)(double const P_T *,
...
/* set XSMALL to x at minimum position */
            ...
            for (i = 1; i <= i__2; ++i) {
                ...
                mtxcpv_(&x0[1], x, nr);
                x[ivar - 1] = xivar;
                lsqnon_(userfn, &t[1], &y[1], &deltay[1], n, nr, &nred1,
