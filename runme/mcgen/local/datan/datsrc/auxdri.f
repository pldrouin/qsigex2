      SUBROUTINE AUXDRI(F,X,TT,NY,NR,NRED,LIST,AA,OK)
C Computes matrix of derivatives
C Based on H. Rutishauser, Ausdehnung des Rombergschen Prinzips
C (Extension of Romberg's Principle), Numer. Math. 5 (1963) 48-54
C Program based on routine DERIV by K.S.Koelbig in
C CERN Computer Center Program Library, CERN, Geneva
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      PARAMETER (EPS = 5.D-8, EPSI=1.D-10, DELTA=10.D0, S=1.D-1)
      DIMENSION X(NR),AA(NY,NRED),TT(NY)
